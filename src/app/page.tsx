...
export default function Home() {
  return (
    <>
        ...
        <header className="flex flex-col gap-10 items-center relative top-28">
        ...
        <main className="flex flex-col items-center mt-40 gap-40 motion-preset-slide-right motion-duration-1500">
